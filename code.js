...
function mostrarPrecio(){
    ...
    if(destinoSeleccionado){
        ...
        El precio de su viaje a ${destinoSeleccionado.destino} por ${diasElegidos} días, para ${personasElegidas} persona/s, con una estadía 
...
// Acá recupero lo del localStorage
...
function cargaLocal (){
    let multiplica = viajeLocal.destinoSeleccionado.precio + (viajeLocal.diasElegidos * viajeLocal.personasElegidas * viajeLocal.hotelSeleccionado.precio) + viajeLocal.excSeleccionada.precio
    document.getElementById("resultado")
    resultado.innerHTML = `
    El precio de su viaje a ${viajeLocal.destinoSeleccionado.destino} con una estadia de ${viajeLocal.diasElegidos} días, para ${viajeLocal.personasElegidas} persona/s, con una estadía ${viajeLocal.hotelSeleccionado.categoria} y con una excursion ${viajeLocal.excSeleccionada.excursion} es de ${multiplica}`
}
